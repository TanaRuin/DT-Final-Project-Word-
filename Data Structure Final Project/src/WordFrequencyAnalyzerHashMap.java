...
public class WordFrequencyAnalyzerHashMap extends JFrame {
    ...
    private static void editSentence(Scanner scanner) {
        ...
        measureTimeElapsed("Edit Sentence", () -> {
            // Update the sentence in the sentences list and totalWordCount
            String oldSentence = sentences.get(finalChoice - 1);
            ...
            sentences.set(finalChoice - 1, newSentence);
    ...
    private static void removeSentence(Scanner scanner) {
        ...
        measureTimeElapsed("Remove Sentence", () ->{
        int index = 0;
